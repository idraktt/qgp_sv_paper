...
filter_calls_quality() {
        ...
        family="${array[0]}";
        echo -e "bcftools view -i '(SVTYPE = \"DEL\" & (INFO/num_Reads[0] > 2) )' $breakdancer_path/lowmq/$name.lowmq.vcf > $breakdancer_path/filtered/$name.filtered.vcf" | bsub -n 1 -e $reports_path/logs/$name-err.txt -o $reports_path/logs/$name-out.txt -q qgp -P ${projectname};
        ...
        echo -e "bcftools view -i '(SVTYPE = \"DEL\" & (INFO/PE[0] > 4 | INFO/SR[0] > 4) ) | (SVTYPE = \"DUP\" & (INFO/PE[0] > 4 | INFO/SR[0] > 4)) | (SVTYPE = \"INV\"& (INFO/PE[0] > 4 | INFO/SR[0] > 4)) ' $delly_path/lowmq/$name.lowmq.vcf > $delly_path/filtered/$name.filtered.vcf" | bsub -n 1 -e $reports_path/logs/$name-err.txt -o $reports_path/logs/$name-out.txt -q qgp -P ${projectname};
        ...
        echo -e "bcftools view -i '(SVTYPE = \"DEL\" & (FORMAT/PR[0:1] > 10 | FORMAT/SR[0:1] > 10) ) | (SVTYPE = \"DUP\" & (FORMAT/PR[0:1] > 16 | FORMAT/SR[0:1] > 16)) | (SVTYPE = \"INV\" & (FORMAT/PR[0:1] > 12 | FORMAT/SR[0:1] > 12))' $manta_path/lowmq/$name.lowmq.vcf > $manta_path/filtered/$name.filtered.vcf" | bsub -n 1 -e $reports_path/logs/$name-err.txt -o $reports_path/logs/$name-out.txt -q qgp -P ${projectname};
        ...
        echo -e "bcftools view -i '(SVTYPE = \"DEL\" & (FORMAT/AD[0] > 16) ) | (SVTYPE = \"DUP\" & (FORMAT/AD[0] > 16)) | (SVTYPE = \"INV\"& (FORMAT/AD[0] > 14)) ' $svaba_path/lowmq/$name.lowmq.vcf > $svaba_path/filtered/$name.filtered.vcf" | bsub -n 1 -e $reports_path/logs/$name-err.txt -o $reports_path/logs/$name-out.txt -q qgp -P ${projectname};
        
        echo -e "bcftools view -i '(SVTYPE = \"DEL\" & (INFO/A[0] > 8) ) | (SVTYPE = \"DUP\" & (INFO/A[0] > 9))| (SVTYPE = \"INV\" & (INFO/A[0] > 6 ))' $wham_path/lowmq/$name.lowmq.vcf > $wham_path/filtered/$name.filtered.vcf" | bsub -n 1 -e $reports_path/logs/$name-err.txt -o $reports_path/logs/$name-out.txt -q qgp -P ${projectname};
