...
dat.in <- "/home/ealiyev_qgp/QF-QBB-RES-ACC-0032/QGP_SV/Publication/publication_plots/data/autosomes.bed"
centromeres.in <- "/home/ealiyev_qgp/QF-QBB-RES-ACC-0032/QGP_SV/Publication/publication_plots/data/centromeres.bed"
nmask.in <- "/home/ealiyev_qgp/QF-QBB-RES-ACC-0032/QGP_SV/Publication/publication_plots/data/nmasks.bed"
...
meta.svtypes <- c("ALL","DEL","DUP","INV")
...
png(paste(OUTDIR,"/",prefix,".SV_density_idiograms_bySVTYPE.png",sep=""),
    height=800,width=2600,res=300,bg="white")
generateCovPlotsPerChrom(mat=lapply(1:22,function(k){return(as.data.frame(dat[which(dat$chr==k),c(1:3,which(colnames(dat) %in% c("DEL","DUP","INV")))]))}),
